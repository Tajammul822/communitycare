    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-md-12 grid-margin-lg-0 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h2 class="card-title">Phase 1</h2>
                        <p class="card-description">
                            Add actions on this Submission
                        </p>
                        <a href="{{ url('chw/phase-one-actions/'.$assign_id.'/'.$user_id)}}" type="button" class="btn btn-success btn-fw" style="float:right">View Actions</a>
                    </div>
                </div>
            </div>
        </div><br><br>
                        ...
                        <form action="{{ route('phase.one.post') }}" method="POST">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <div id="the-basics">
                                        <input class="typeahead" type="text" placeholder="2013-03-04" disabled>
                                    </div>
                                </div>
                                <div class="col-md-6">
